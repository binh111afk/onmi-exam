...
export const OCR_NOISE_REPLACEMENTS: OcrReplacementRule[] = [
  ...
  // Math & Vector OCR repairs for Benchmark Benchmark Q1-Q13
  ...
  { pattern: /y=4sin\s+x\s*[–-−]2\s+3là/giu, replacement: '$y = 4\\sin x - 2\\sqrt{3}$ là', category: 'word-repair', confidence: 0.95 },
